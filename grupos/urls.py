...
urlpatterns = [
	...
	url(r'^main/(?P<id_grupo>\d+)/libros/$', views.main_grupo_libros, name="main_grupo_libros"),
	url(r'^main/(?P<id_grupo>\d+)/actividad/$', views.main_grupo_actividad, name="main_grupo_actividad"),
